...
const SLIDES = [
  {
    ...
    title: 'Clean water\nstarts with you',
    body: "WA-01's waterways — the Snohomish, Stillaguamish, and Sammamish rivers — face daily threats from pollution. Most incidents go unreported because reporting is too hard.",
    detail: 'StreamWatch changes that.',
  },
  {
    emoji: '📸',
    ...
    detail: null,
    steps: [
      { emoji: '📷', label: 'Photograph', sub: 'Point your camera at any waterway' },
      { emoji: '🤖', label: 'AI classifies', sub: 'YOLOv8 identifies the pollution type' },
      { emoji: '📧', label: 'Agency notified', sub: 'The right authority gets an alert instantly' },
    ],
  },
  {
    emoji: '🗺️',
    ...
    title: 'Every report\nbuilds the picture',
    body: 'See real-time waterway health scores, what\'s at risk downstream — beaches, salmon habitat, drinking water — and how your community is making a difference.',
    detail: null,
  },
];
